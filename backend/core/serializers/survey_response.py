...
class SurveyResponseCalculationSerializer(serializers.Serializer):
    ...
    absolute = serializers.DecimalField(max_digits=None, decimal_places=5, read_only=True)
    scoring_level = serializers.IntegerField(required=False)
    indicator_impact = serializers.DecimalField(max_digits=None, decimal_places=5, read_only=True)
    critical_impact = serializers.BooleanField(required=False)
    outliers = serializers.BooleanField(required=False)
